...
Illumina analysis generated a total of `r total_reads` sequences that were normalized to `r rare_reads` after rarefaction [@Schloss2024]. Soil samples have the highest shannon diversity index and richness, followed by pottery exterior samples, and pottery interior samples, and negative control. 
