...
The dominant classes include *Bacilli*, *Clostridia*, and *Negativicutes* among *Firmicutes*; *Actinobacteria*, *Rubrobacteria*, *Thermoleophilia* among *Actinobacteria*, *Deinococci* in *Deinococcus*, and *Gammaproteobacteria*, *Alphaproteobacteria*, and *Deltaproteobacteria* among *Proteobacteria*. At the family level, significant differences were observed between pottery exterior samples and control samples, and between pottery exterior and interior samples. *Paenibacillaceae*, *Erysipelotrichaceae*, and *Xiphinematobacteraceae* were more abundant in pottery exterior samples than those in control samples (P <0.05). In addition to *Paenibacillaceae* and *Xiphinematobacteraceae*, *Phycisphaeraceae* was more abundant in pottery exterior samples than in pottery interior samples (P <0.05). At the genus level, pottery exterior samples exhibit significantly higher abundance of *Candidatus_Xiphinematobacter* compared to pottery interior samples and control samples (P < 0.01). Among the bacterial taxa showing significant differences, only *Paenibacillaceae* displayed relative abundances exceeding 10% on average, while others were below 1%.
