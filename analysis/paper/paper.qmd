...
To minimize potential sources of contamination from the environments, we cleaned all lab benches and pipettors using 99% ethanol and UV light before sample preparation and DNA extraction. These procedures were conducted in the biomolecular laboratory facilities at Academia Sinica, Taiwan. Because contemporary contamination could be a significant concern when interpreting the data, we used blank controls during sample preparation, DNA extraction, and DNA amplification to monitor extraneous DNA from surroundings, solutions and reagents, and consumables. A total of 12 powdered pottery samples (interior and exterior parts), five soil samples from Guijiabao and Gaoshan, and three negative control samples were tested in this study.

## sample preparation 

Each pottery sample was divided into two distinct portions: the interior, representing the middle part of the potsherd matrix, and the exterior surface exposed to the environment. This division aimed to facilitate a comparative analysis of the microbial communities in residues absorbed into the potsherds versus those on the surface. The collection of approximately 1g of the interior potsherd was executed using a sterile drill operated at a low speed to prevent heat generation. The powdered sample was initially gathered on a pre-combustion foil and subsequently transferred into pre-sterilized tubes. A parallel sampling procedure was conducted for the surface of the potsherds, with the drill being cleaned between each iteration to minimize cross-contamination. For the soil samples, around 1g was collected from the tube containing the soil samples using sterile spatulas.

## DNA extraction and amplification

Total DNA was extracted for each sample using the DNeasy Power Soil Pro Kit (QIAGEN). All DNAs were quantified using Qubit Fluorometer.
